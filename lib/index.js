...
var getFields = function (endpoints, isMutation, gqlTypes, _a) {
    ...
    return Object.keys(endpoints)
        ...
        var type = typeMap_1.jsonSchemaTypeToGraphQL(operationId, endpoint.response &&
            Object.keys(endpoint.response).length !== 0 &&
            Object.keys(endpoint.response).includes('type')
            ? endpoint.response
            : { type: 'object', properties: {} }, 'response', false, gqlTypes, true);
        var gType = {
            type: type,
            description: endpoint.description,
            args: typeMap_1.mapParametersToFields(endpoint.parameters, operationId, gqlTypes),
            resolve: function (_source, args, context, info) { return __awaiter(_this, void 0, void 0, function () {
                var _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _a = parseResponse;
                            return [4 /*yield*/, callBackend({
                                    context: context,
...
exports.createSchema = function (options) { return __awaiter(_this, void 0, void 0, function () {
    var schemaWithoutReferences, swaggerSchema, endpoints;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, json_schema_ref_parser_1.default.dereference(options.swaggerSchema)];
            case 1:
                ...
                return [2 /*return*/, schemaFromEndpoints(endpoints, options)];
        }
    });
}); };
